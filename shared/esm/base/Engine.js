...
export default function Engine(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        var AudioLow, AudioHigh, VideoLow, VideoHigh, ManifestLow, ManifestHigh, AudioLowDRC, AudioHighDRC, VideoLowHDR, VideoHighHDR, AudioLowF, AudioHighF, VideoLowF, VideoHighF, dirC, pLoc, maxT, enginePath, metaCore, i, payLoad;
        var _this = this;
