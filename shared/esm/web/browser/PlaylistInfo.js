...
export default function PlaylistInfo(input) {
    return __awaiter(this, void 0, void 0, function () {
        var query, QuerySchema, _a, screenshot, verbose, onionTor, metaTube, i, content, $, playlistTitle, viewsText, playlistViews, playlistDescription;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 10:
                    ...
                    $("ytd-playlist-video-renderer").each(function (_index, element) { return __awaiter(_this, void 0, void 0, function () {
                        var title, videoLink, videoId, newLink, author, authorUrl, views, ago, thumbnailUrls;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    title = $(element).find("h3").text().trim();
                                    videoLink = "https://www.youtube.com" + $(element).find("a").attr("href");
                                    return [4 /*yield*/, YouTubeId(videoLink)];
                                case 1:
                                    videoId = _a.sent();
                                    newLink = "https://www.youtube.com/watch?v=" + videoId;
                                    author = $(element)
