...
async function Engine({
  ...
  let LowVideoHDR = {};
  let HighVideoHDR = {};
  let LowestAudioFileSize = null;
  let HighestAudioFileSize = null;
  let LowestVideoFileSize = null;
  let HighestVideoFileSize = null;
  ...
  i.formats.forEach((tube) => {
    ...
    if (tube.format_note.includes("DRC")) {
      ...
      if (!LowVideoHDR[tube.format_note] || tube.filesize < LowVideoHDR[tube.format_note].filesize)
        LowVideoHDR[tube.format_note] = tube;
      if (!HighVideoHDR[tube.format_note] || tube.filesize > HighVideoHDR[tube.format_note].filesize)
  ...
  Object.values(LowAudio).forEach((audio) => {
    if (audio.filesize !== null) {
      switch (true) {
        case (!LowestAudioFileSize || audio.filesize < LowestAudioFileSize.filesize):
          LowestAudioFileSize = audio;
          break;
        case (!HighestAudioFileSize || audio.filesize > HighestAudioFileSize.filesize):
          HighestAudioFileSize = audio;
          break;
      }
    }
  });
  Object.values(LowVideo).forEach((video) => {
    if (video.filesize !== null) {
      switch (true) {
        case (!LowestVideoFileSize || video.filesize < LowestVideoFileSize.filesize):
          LowestVideoFileSize = video;
          break;
        case (!HighestVideoFileSize || video.filesize > HighestVideoFileSize.filesize):
  ...
  const payLoad = {
    ...
    HighestAudioFileSize: (() => {
      const pop = HighestAudioFileSize || {};
      pop.filesizeP = sizeFormat(pop.filesize);
      delete pop.format_id;
      delete pop.source_preference;
      delete pop.has_drm;
    ...
    HighestVideoFileSize: (() => {
      const pop = HighestVideoFileSize || {};
      pop.filesizeP = sizeFormat(pop.filesize);
      delete pop.asr;
      delete pop.format_id;
      delete pop.has_drm;
    ...
    LowAudioDRC: Object.values(LowAudioDRC).map((i2) => ({
    ...
    HighAudioDRC: Object.values(HighAudioDRC).map((i2) => ({
      filesize: i2.filesize,
      filesizeP: sizeFormat(i2.filesize),
      asr: parseFloat(i2.asr),
      format_note: i2.format_note,
    ...
    LowAudio: propfilter(Object.values(LowAudio)).map((i2) => ({
      filesize: i2.filesize,
      filesizeP: sizeFormat(i2.filesize),
      asr: parseFloat(i2.asr),
      format_note: i2.format_note,
    ...
    HighAudio: propfilter(Object.values(HighAudio)).map((i2) => ({
      filesize: i2.filesize,
      filesizeP: sizeFormat(i2.filesize),
      asr: parseFloat(i2.asr),
      format_note: i2.format_note,
    ...
    LowVideoHDR: Object.values(LowVideoHDR).map((i2) => ({
      filesize: i2.filesize,
      filesizeP: sizeFormat(i2.filesize),
      format_note: i2.format_note,
    ...
    HighVideoHDR: Object.values(HighVideoHDR).map((i2) => ({
      filesize: i2.filesize,
      filesizeP: sizeFormat(i2.filesize),
      format_note: i2.format_note,
      fps: parseFloat(i2.fps),
    ...
    LowVideo: propfilter(Object.values(LowVideo)).map((i2) => ({
      filesize: i2.filesize,
      filesizeP: sizeFormat(i2.filesize),
      format_note: i2.format_note,
      fps: parseFloat(i2.fps),
    ...
    HighVideo: propfilter(Object.values(HighVideo)).map((i2) => ({
      filesize: i2.filesize,
      filesizeP: sizeFormat(i2.filesize),
      format_note: i2.format_note,
      fps: parseFloat(i2.fps),
    ...
    LowManifest: Object.values(LowManifest).map((i2) => ({
      url: i2.url,
    ...
    HighManifest: Object.values(HighManifest).map((i2) => ({
      url: i2.url,
      manifest_url: i2.manifest_url,
      tbr: parseFloat(i2.tbr),
      ext: i2.ext,
