...
async function SearchVideos(input) {
  try {
    ...
    let snapshot;
    spinnies.add(spin, {
      text: colors22__default.default.green("@scrape: ") + "booting chromium..."
    });
    switch (input.type) {
      case "video":
        TubeResp = await retry__default.default(async () => {
          ...
          spinnies.update(spin, {
            text: colors22__default.default.yellow("@scrape: ") + "waiting for hydration..."
          });
          if (screenshot) {
          ...
          spinnies.succeed(spin, {
            text: colors22__default.default.green("@info: ") + colors22__default.default.white("scrapping done for ") + query
          });
          return metaTube;
        }, retryOptions);
        if (browser)
      ...
      default:
        spinnies.fail(spin, {
          text: colors22__default.default.red("@error: ") + colors22__default.default.white("wrong filter type provided.")
        });
        if (browser)
          await browser.close();
        return void 0;
    ...
    switch (true) {
      case error instanceof z4.ZodError:
        throw new Error(
          colors22__default.default.red("@error: ") + error.errors.map((error2) => error2.message).join(", ")
        );
      case error instanceof Error:
        throw new Error(colors22__default.default.red("@error: ") + error.message);
      default:
...
function help() {
  return Promise.resolve(
    colors22__default.default.bold.white(`
\u2715\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2715
...
async function Engine(query) {
  try {
    ...
    if (proLoc !== "") {
      ...
      throw new Error(
        colors22__default.default.red("@error: ") + "could not find the engine file."
      );
    }
...
async function extract_playlist_videos({
  ...
  try {
    ...
    await eachSeries$1(playlistUrls, async (listLink) => {
      ...
      if (query === void 0) {
        console.error(
          colors22__default.default.bold.red("@error: "),
        ...
        if (resp === void 0) {
          ...
          console.log(
            ...
            colors22__default.default.green(resp.playlistTitle),
...
async function lowEntry(metaBody) {
  if (!metaBody || metaBody.length === 0) {
    console.log(colors22__default.default.red("@error:"), "sorry no downloadable data found");
    return void 0;
  }
...
var progressBar = (prog) => {
  ...
  if (prog.timemark === void 0)
    return;
  let color = colors22__default.default.green;
  if (prog.percent >= 98)
    prog.percent = 100;
  ...
  if (prog.percent < 20)
    color = colors22__default.default.red;
  else if (prog.percent < 80)
    color = colors22__default.default.yellow;
...
var program = async () => {
  ...
  switch (command) {
    case "version":
    case "v":
      console.error(colors22__default.default.green("Installed Version: yt-dlx@" + version));
      break;
    case "help":
    case "h":
      core_default.info.help().then((data) => {
        ...
        console.error(colors22__default.default.red(error));
        process.exit();
      });
      break;
    case "extract":
    case "e":
      if (!proTube || !proTube.query || proTube.query.length === 0) {
        console.error(colors22__default.default.red("error: no query"));
      } else
    ...
    case "aqc":
      ...
      if (!proTube || !proTube.format || proTube.format.length === 0) {
        console.error(colors22__default.default.red("error: no format"));
      }
