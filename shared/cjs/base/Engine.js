...
// =====================================================================================
function Engine(_a) {
    return __awaiter(this, arguments, void 0, function* ({ query, ipAddress, onionTor, }) {
        let AudioLow = {};
        let AudioHigh = {};
        let VideoLow = {};
        let VideoHigh = {};
        ...
        const metaCore = yield (0, async_retry_1.default)(() => __awaiter(this, void 0, void 0, function* () {
            if (onionTor)
            ...
            return yield (0, util_1.promisify)(child_process_1.exec)(pLoc);
        }), {
            factor: 2,
            retries: 3,
            minTimeout: 1000,
