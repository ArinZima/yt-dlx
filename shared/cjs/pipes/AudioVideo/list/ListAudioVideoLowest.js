...
function ListAudioVideoLowest(input) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        let startTime;
        const { query, verbose, output, filter, onionTor } = yield qconf.parseAsync(input);
        const vDATA = new Set();
        for (const pURL of query) {
            try {
                ...
                if (pDATA === undefined) {
                    console.log(colors_1.default.red("@error:"), "unable to get response from youtube for", pURL);
                    continue;
                }
        ...
        for (const video of vDATA) {
            try {
                ...
                const vdata = Array.isArray(engineData.ManifestLow) &&
                    ...
                    ? (_a = engineData.ManifestLow[0]) === null || _a === void 0 ? void 0 : _a.url
                    : undefined;
