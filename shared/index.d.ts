...
declare function AudioLowest(input: AudioLowestOC): Promise<true | StreamResult>;
...
declare function AudioHighest(input: AudioHighestOC): Promise<true | StreamResult>;
...
declare function VideoLowest$1(input: VideoLowestOC$1): Promise<true | StreamResult>;
...
declare function VideoHighest(input: VideoHighestOC): Promise<true | StreamResult>;

type VideoFormat$7 = "webm" | "avi" | "mov";
...
declare function AudioVideoLowest(input: AudioVideoLowestOC): Promise<true | StreamResult>;

type VideoFormat$6 = "webm" | "avi" | "mov";
...
declare function AudioVideoHighest(input: AudioVideoHighestOC): Promise<true | StreamResult>;
...
declare function VideoLowest(input: VideoLowestOC): Promise<true | StreamResult>;
...
type VideoFormat$1 = "webm" | "avi" | "mov";
