...
rl.question(
  ...
  (answer) => {
    switch (answer.trim()) {
      case "clean":
        console.clear();
        console.log("Performing clean operation...");
        execSync("yarn run clean", { stdio: "inherit" });
        break;
      case "build":
        console.clear();
        console.log("Performing build operation...");
        execSync("yarn run build", { stdio: "inherit" });
        break;
      case "make":
        console.clear();
        console.log("Performing make operation...");
      ...
      case "remake":
        console.clear();
        console.log("Performing remake operation...");
        execSync("yarn run remake", { stdio: "inherit" });
        break;
      case "setup":
        console.clear();
        console.log("Performing setup operation...");
        execSync("yarn run setup", { stdio: "inherit" });
        break;
      case "test":
        console.clear();
        console.log("Performing test operation...");
        execSync("yarn run test", { stdio: "inherit" });
        break;
      case "spec":
        console.clear();
        console.log("Performing spec operation...");
        execSync("yarn run spec", { stdio: "inherit" });
        break;
      case "cli":
        console.clear();
        console.log("Performing cli operation...");
        execSync("yarn run cli", { stdio: "inherit" });
        break;
      case "upload":
        console.clear();
        console.log("Performing upload operation...");
