        ...
        <div className="max-w-screen-4xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="max-w-screen-2xl">
            <h2 className="text-3xl font-bold sm:text-4xl text-red-600">
              Viewing YtDlx.AudioOnly.List.Lowest()
            </h2>
            ...
            <ul className="list-disc m-4 bg-neutral-800/40 shadow-black shadow-2xl p-8 rounded-3xl border border-dashed border-red-600">
              <li>
                Downloads and processes the lowest quality audio from a List
                YouTube video.
              </li>
...
(async () => {
  try {
    ...
    await ytdlx.AudioOnly.List.Lowest({
    ...
    const result = await ytdlx.AudioOnly.List.Lowest({
      query: "video-link-or-video-name-or-video-id",
      filter: "flanger", 
      onionTor: false, 
      output: "audio", 
...
(async () => {
  try {
    console.log("@info: with stream: false");
    await ytdlx.default.AudioOnly.List.Lowest({
      query: "video-link-or-video-name-or-video-id",
      filter: "flanger", 
      onionTor: false, 
      output: "audio", 
    ...
    console.log("@info: with stream: true");
    const result = await ytdlx.default.AudioOnly.List.Lowest({
      query: "video-link-or-video-name-or-video-id",
      filter: "flanger", 
      onionTor: false, 
      output: "audio", 
...
(async () => {
  try {
    console.log("@info: with stream: false");
    await ytdlx.AudioOnly.default.List.Lowest({
      query: "video-link-or-video-name-or-video-id",
      filter: "flanger", 
      onionTor: false, 
      output: "audio", 
