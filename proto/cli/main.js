...
var colors19__default = /*#__PURE__*/_interopDefault(colors19);
...
// scripts/pipes/command/help.ts
init_cjs_shims();
function help() {
  return Promise.resolve(
    colors19__default.default.bold.white(`
\u2715\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2715
...
var DomHandler = class {
  ...
  addNode(node) {
    const parent3 = this.tagStack[this.tagStack.length - 1];
    const previousSibling = parent3.children[parent3.children.length - 1];
...
function getSiblings(elem) {
  const parent3 = getParent(elem);
  if (parent3 != null)
    return getChildren(parent3);
...
function replaceElement(elem, replacement) {
  ...
  const parent3 = replacement.parent = elem.parent;
  if (parent3) {
    const childs = parent3.children;
    childs[childs.lastIndexOf(elem)] = replacement;
    elem.parent = null;
  }
}
function appendChild(parent3, child) {
  removeElement(child);
  child.next = null;
  child.parent = parent3;
  if (parent3.children.push(child) > 1) {
    const sibling = parent3.children[parent3.children.length - 2];
    sibling.next = child;
    child.prev = sibling;
  } else {
    child.prev = null;
...
function append(elem, next2) {
  removeElement(next2);
  const { parent: parent3 } = elem;
  const currNext = elem.next;
  next2.next = currNext;
  next2.prev = elem;
  elem.next = next2;
  next2.parent = parent3;
  if (currNext) {
    currNext.prev = next2;
    if (parent3) {
      const childs = parent3.children;
    ...
    parent3.children.push(next2);
  }
}
function prependChild(parent3, child) {
  removeElement(child);
  child.parent = parent3;
  child.prev = null;
  if (parent3.children.unshift(child) !== 1) {
    const sibling = parent3.children[1];
    sibling.prev = child;
    child.next = sibling;
  } else {
    child.next = null;
...
function getChildFunc(next2, adapter2) {
  return (elem) => {
    const parent3 = adapter2.getParent(elem);
    return parent3 != null && adapter2.isTag(parent3) && next2(elem);
  };
}
var filters = {
...
function getElementParent(node, adapter2) {
  const parent3 = adapter2.getParent(node);
  if (parent3 && adapter2.isTag(parent3)) {
    return parent3;
  }
  return null;
}
  ...
  switch (selector.type) {
    ...
    case SelectorType.Child: {
      return function child(elem) {
        const parent3 = adapter2.getParent(elem);
        return parent3 != null && adapter2.isTag(parent3) && next2(parent3);
      };
    }
    case SelectorType.Sibling: {
...
function absolutize(token, { adapter: adapter2 }, context) {
  const hasContext = !!(context === null || context === void 0 ? void 0 : context.every((e) => {
    const parent3 = adapter2.isTag(e) && adapter2.getParent(e);
    return e === PLACEHOLDER_ELEMENT || parent3 && adapter2.isTag(parent3);
  }));
...
var parent = _singleMatcher(({ parent: parent3 }) => parent3 && !isDocument(parent3) ? parent3 : null, _removeDuplicates);
...
var parentsUntil = _matchUntil(({ parent: parent3 }) => parent3 && !isDocument(parent3) ? parent3 : null, uniqueSort, (elems) => elems.reverse());
...
function update(newChilds, parent3) {
  const arr = Array.isArray(newChilds) ? newChilds : [newChilds];
  if (parent3) {
    parent3.children = arr;
  } else {
    parent3 = null;
  }
...
function uniqueSplice(array, spliceIdx, spliceCount, newElems, parent3) {
  var _a2, _b;
  const spliceArgs = [
    spliceIdx,
    spliceCount,
  ...
  for (let idx = 0; idx < newElems.length; ++idx) {
    ...
    if (oldParent) {
      ...
      if (prevIdx > -1) {
        ...
        if (parent3 === oldParent && spliceIdx > prevIdx) {
          spliceArgs[0]--;
        }
      }
    }
...
var append2 = _insert((dom, children2, parent3) => {
  uniqueSplice(children2, children2.length, 0, dom, parent3);
});
var prepend2 = _insert((dom, children2, parent3) => {
  uniqueSplice(children2, 0, 0, dom, parent3);
});
...
var wrap = _wrap((el, elInsertLocation, wrapperDom) => {
  const { parent: parent3 } = el;
  if (!parent3)
    return;
  const siblings2 = parent3.children;
  const index3 = siblings2.indexOf(el);
  update([el], elInsertLocation);
  uniqueSplice(siblings2, index3, 0, wrapperDom, parent3);
});
...
function after(...elems) {
  ...
  return domEach(this, (el, i) => {
    ...
    const domSrc = typeof elems[0] === "function" ? elems[0].call(el, i, this._render(el.children)) : elems;
    const dom = this._makeDomArray(domSrc, i < lastIdx);
    uniqueSplice(siblings2, index3 + 1, 0, dom, parent3);
  });
}
function insertAfter(target) {
  ...
  this._makeDomArray(target).forEach((el) => {
    ...
    if (index3 < 0)
      return;
    uniqueSplice(siblings2, index3 + 1, 0, clonedSelf, parent3);
...
function before(...elems) {
  ...
  return domEach(this, (el, i) => {
    ...
    const domSrc = typeof elems[0] === "function" ? elems[0].call(el, i, this._render(el.children)) : elems;
    const dom = this._makeDomArray(domSrc, i < lastIdx);
    uniqueSplice(siblings2, index3, 0, dom, parent3);
  });
}
function insertBefore(target) {
  ...
  domEach(targetArr, (el) => {
    ...
    if (index3 < 0)
      return;
    uniqueSplice(siblings2, index3, 0, clonedSelf, parent3);
    clones.push(...clonedSelf);
  });
  return this._make(clones);
}
...
function replaceWith(content) {
  return domEach(this, (el, i) => {
    ...
    update(dom, null);
    const index3 = siblings2.indexOf(el);
    uniqueSplice(siblings2, index3, 1, dom, parent3);
    if (!dom.includes(el)) {
...
var Parser = class {
  ...
  _attachElementToTree(element, location) {
    ...
    if (this._shouldFosterParentOnInsertion()) {
      ...
      const parent3 = this.openElements.currentTmplContentOrNode;
      this.treeAdapter.appendChild(parent3, element);
    }
  }
  ...
  _appendCommentNode(token, parent3) {
    const commentNode = this.treeAdapter.createCommentNode(token.data);
    this.treeAdapter.appendChild(parent3, commentNode);
    if (this.options.sourceCodeLocationInfo) {
  ...
  _insertCharacters(token) {
    ...
    let beforeElement;
    if (this._shouldFosterParentOnInsertion()) {
      ({ parent: parent3, beforeElement } = this._findFosterParentingLocation());
      if (beforeElement) {
        this.treeAdapter.insertTextBefore(parent3, token.chars, beforeElement);
      } else {
        this.treeAdapter.insertText(parent3, token.chars);
      }
    } else {
      parent3 = this.openElements.currentTmplContentOrNode;
      this.treeAdapter.insertText(parent3, token.chars);
    }
    if (!token.location)
      return;
    const siblings2 = this.treeAdapter.getChildNodes(parent3);
  ...
  _findFosterParentingLocation() {
    for (let i = this.openElements.stackTop; i >= 0; i--) {
      ...
      switch (this.openElements.tagIDs[i]) {
        ...
        case TAG_ID.TABLE: {
          const parent3 = this.treeAdapter.getParentNode(openElement);
          if (parent3) {
            return { parent: parent3, beforeElement: openElement };
          }
...
function serializeTextNode(node, options) {
  ...
  const parent3 = treeAdapter.getParentNode(node);
  const parentTn = parent3 && treeAdapter.isElementNode(parent3) && treeAdapter.getTagName(parent3);
  return parentTn && treeAdapter.getNamespaceURI(parent3) === NS.HTML && hasUnescapedText(parentTn, options.scriptingEnabled) ? content : escapeText(content);
}
...
// scripts/web/webVideo.ts
var spinnies = new spinClient__default.default();
async function webVideo({
  ...
  try {
    const metaTube = await retry__default.default(async () => {
      ...
      const title = $2(".style-scope.ytd-watch-metadata").text().trim();
      const views = $2(".bold.style-scope.yt-formatted-string").filter((_, vide) => $2(vide).text().includes("views")).text().trim().replace(/ views/g, "");
      const thumbnailUrls = [
      ...
      const uploadElements = $2(".bold.style-scope.yt-formatted-string").map((_, vide) => {
        const text3 = $2(vide).text().trim();
        return text3.includes("ago") ? text3 : void 0;
      }).get();
      const author = $2(".ytd-channel-name a").text().trim();
      const data2 = {
        views,
        author,
        videoId,
    ...
    spinnies.succeed(spin, {
      text: colors19__default.default.yellow("@info: ") + colors19__default.default.white("scrapping done, video found " + metaTube.title)
    });
    return metaTube;
  } catch (error) {
    spinnies.fail(spin, {
      text: colors19__default.default.red("@error: ") + error.message
    });
    return void 0;
  }
}

// scripts/web/webSearch.ts
init_cjs_shims();
var spinnies2 = new spinClient__default.default();
async function webSearch({
  ...
  try {
    const metaTube = await retry__default.default(async () => {
      ...
      const videoElements = $2(
        "ytd-video-renderer:not([class*='ytd-rich-grid-video-renderer'])"
      );
      videoElements.each(async (_, vide) => {
        const title = $2(vide).find("#video-title").text().trim();
        const videoLink = "https://www.youtube.com" + $2(vide).find("a").attr("href");
        const videoId = await YouTubeID(videoLink);
        const newLink = "https://www.youtube.com/watch?v=" + videoId;
        ...
        let description = "";
        const descriptionElement = $2(vide).find(".metadata-snippet-text");
        if (descriptionElement) {
          description = descriptionElement.text().trim();
        }
        const views = $2(vide).find(".inline-metadata-item.style-scope.ytd-video-meta-block").filter((_2, vide2) => $2(vide2).text().includes("views")).text().trim().replace(/ views/g, "");
        const uploadedOnElement = $2(vide).find(
          ".inline-metadata-item.style-scope.ytd-video-meta-block"
        );
        const uploadOn = uploadedOnElement.length >= 2 ? $2(uploadedOnElement[1]).text().trim() : void 0;
        const thumbnailUrls = [
          `https://img.youtube.com/vi/${videoId}/maxresdefault.jpg`,
          `https://img.youtube.com/vi/${videoId}/sddefault.jpg`,
          `https://img.youtube.com/vi/${videoId}/mqdefault.jpg`,
    ...
    spinnies2.succeed(spin, {
      text: colors19__default.default.yellow("@info: ") + colors19__default.default.white("scrapping done, total videos found " + metaTube.length)
    });
    return metaTube;
  } catch (error) {
    spinnies2.fail(spin, {
...
// scripts/web/webPlaylist.ts
init_cjs_shims();
var spinnies3 = new spinClient__default.default();
async function webPlaylist({
  ...
  try {
    const metaTube = await retry__default.default(async () => {
      ...
      const VideoElements = $2("ytd-playlist-video-renderer");
      VideoElements.each(async (_, vide) => {
        const title = $2(vide).find("h3").text().trim();
        const videoLink = "https://www.youtube.com" + $2(vide).find("a").attr("href");
        const videoId = await YouTubeID(videoLink);
        const newLink = "https://www.youtube.com/watch?v=" + videoId;
        const author = $2(vide).find(".yt-simple-endpoint.style-scope.yt-formatted-string").text();
        const authorUrl = "https://www.youtube.com" + $2(vide).find(".yt-simple-endpoint.style-scope.yt-formatted-string").attr("href");
        const views2 = $2(vide).find(".style-scope.ytd-video-meta-block span:first-child").text();
        const ago = $2(vide).find(".style-scope.ytd-video-meta-block span:last-child").text();
        const thumbnailUrls = [
          `https://img.youtube.com/vi/${videoId}/maxresdefault.jpg`,
          `https://img.youtube.com/vi/${videoId}/sddefault.jpg`,
          `https://img.youtube.com/vi/${videoId}/mqdefault.jpg`,
    ...
    spinnies3.succeed(spin, {
      text: colors19__default.default.yellow("@info: ") + colors19__default.default.white(
...
async function Engine({
  ...
  console.log(
    colors19__default.default.bold.green("@info: ") + `using yt-dlx version <(${version})>` + colors19__default.default.reset("")
  );
  if (!query || query.trim() === "") {
    console.log(
      colors19__default.default.bold.red("@error: ") + "'query' is required..." + colors19__default.default.reset("")
    );
    return null;
  } else if (/https/i.test(query) && /list/i.test(query)) {
    console.log(
      colors19__default.default.bold.red("@error: ") + "use extract_playlist_videos() for playlists..." + colors19__default.default.reset("")
    );
    return null;
  } else if (/https/i.test(query) && !/list/i.test(query)) {
    console.log(
      colors19__default.default.bold.green("@info: ") + `fetching metadata for: <(${query})>` + colors19__default.default.reset("")
    );
  ...
  switch (videoId) {
    case null:
      ...
      if (TubeBody === null) {
        console.log(
          colors19__default.default.bold.red("@error: ") + "no data returned from server..." + colors19__default.default.reset("")
        );
        return null;
      }
      console.log(
        colors19__default.default.bold.green("@info: ") + `preparing payload for <(${TubeBody[0].title} Author: ${TubeBody[0].author})>` + colors19__default.default.reset("")
      );
    ...
    default:
      ...
      console.log(
        colors19__default.default.bold.green("@info: ") + `preparing payload for <(${TubeBody.title} Author: ${TubeBody.author})>` + colors19__default.default.reset("")
      );
  ...
  switch (TubeDlp) {
    ...
    default:
      console.log(
        colors19__default.default.bold.green("@info:"),
...
// scripts/pipes/command/get_playlist.ts
init_cjs_shims();
async function get_playlist({
  ...
  try {
    ...
    for (const videoLink of playlistUrls) {
      ...
      if (!ispUrl) {
        console.error(
          colors19__default.default.bold.red("@error: "),
      ...
      for (let i = 0; i < resp.videos.length; i++) {
        try {
          ...
          console.log(
            colors19__default.default.bold.green("INFO:"),
            colors19__default.default.bold.green("<("),
            metaTube.title,
            colors19__default.default.bold.green("by"),
            metaTube.author,
            colors19__default.default.bold.green(")>")
          );
          ...
          console.error(colors19__default.default.bold.red("@error: "), error);
        }
      }
    }
    return proTubeArr;
...
// scripts/pipes/command/list_formats.ts
init_cjs_shims();
function list_formats({
  ...
  return new Promise(async (resolve, reject2) => {
    try {
      ...
      const fprem = (data2) => data2.filter(
...
// scripts/pipes/command/get_video_data.ts
init_cjs_shims();
...
// scripts/pipes/command/extract_playlist_videos.ts
init_cjs_shims();
      ...
      for (let i = 0; i < resp.videos.length; i++) {
        try {
          ...
          if (processedVideoIds.has(videoId))
            continue;
          const data2 = await Engine({ query: videoId });
          if (data2 instanceof Array)
            proTubeArr.push(...data2);
          else
            proTubeArr.push(data2);
...
// scripts/pipes/audio/AudioHighest.ts
init_cjs_shims();

// scripts/base/bigEntry.ts
init_cjs_shims();
...
// scripts/pipes/video/VideoLowest.ts
init_cjs_shims();
...
// scripts/pipes/video/VideoHighest.ts
init_cjs_shims();
...
// scripts/pipes/mix/AudioVideoLowest.ts
init_cjs_shims();
...
// scripts/pipes/mix/AudioVideoHighest.ts
init_cjs_shims();
...
// scripts/pipes/audio/AudioQualityCustom.ts
init_cjs_shims();
...
// scripts/pipes/video/VideoQualityCustom.ts
init_cjs_shims();
...
// scripts/pipes/video/ListVideoLowest.ts
init_cjs_shims();
...
// scripts/pipes/video/ListVideoHighest.ts
init_cjs_shims();
...
// scripts/pipes/video/ListVideoQualityCustom.ts
init_cjs_shims();
...
// scripts/pipes/audio/ListAudioLowest.ts
init_cjs_shims();
...
// scripts/pipes/audio/ListAudioHighest.ts
init_cjs_shims();
...
// scripts/pipes/audio/ListAudioQualityCustom.ts
init_cjs_shims();
...
// scripts/pipes/mix/ListAudioVideoLowest.ts
init_cjs_shims();
...
function stripComments(string3) {
  ...
  while (index3 < string3.length) {
    if (string3[index3] === "/" && string3[index3 + 1] === "/") {
      let endIndex = string3.indexOf("\n", index3);
      index3 = endIndex === -1 ? string3.length : endIndex;
    } else if (endBlockComment !== -1 && string3[index3] === "/" && string3[index3 + 1] === "*") {
      let endIndex = string3.indexOf("*/", index3);
      if (endIndex !== -1) {
        index3 = endIndex + 2;
        endBlockComment = string3.indexOf("*/", index3);
      } else {
        stripped += string3[index3];
        index3++;
      }
    } else {
      stripped += string3[index3];
...
function queue$1(worker, concurrency, payload) {
  ...
  function _insert2(data2, insertAtFront, rejectOnError, callback) {
  ...
  var q = {
    ...
    *[Symbol.iterator]() {
    ...
    push(data2, callback) {
      if (Array.isArray(data2)) {
        if (_maybeDrain(data2))
          return;
        return data2.map((datum) => _insert2(datum, false, false, callback));
      }
      return _insert2(data2, false, false, callback);
    },
    pushAsync(data2, callback) {
      if (Array.isArray(data2)) {
        if (_maybeDrain(data2))
          return;
        return data2.map((datum) => _insert2(datum, false, true, callback));
      }
      return _insert2(data2, false, true, callback);
    },
    kill() {
      off();
      q._tasks.empty();
    ...
    unshift(data2, callback) {
      if (Array.isArray(data2)) {
        if (_maybeDrain(data2))
          return;
        return data2.map((datum) => _insert2(datum, true, false, callback));
      }
      return _insert2(data2, true, false, callback);
    },
    unshiftAsync(data2, callback) {
      if (Array.isArray(data2)) {
        if (_maybeDrain(data2))
          return;
        return data2.map((datum) => _insert2(datum, true, true, callback));
      }
      return _insert2(data2, true, true, callback);
    },
    remove(testFn) {
...
var each2 = awaitify(eachLimit$2, 3);
...
function mapValuesLimit(obj, limit, iteratee, callback) {
  ...
  var newObj = {};
  var _iteratee = wrapAsync(iteratee);
  return eachOfLimit$2(limit)(obj, (val2, key, next2) => {
...
var Heap = class {
  ...
  percUp(index3) {
    let p;
    while (index3 > 0 && smaller(this.heap[index3], this.heap[p = parent2(index3)])) {
  ...
  *[Symbol.iterator]() {
  ...
  remove(testFn) {
    ...
    this.heap.splice(j);
    for (let i = parent2(this.heap.length - 1); i >= 0; i--) {
      this.percDown(i);
    }
    return this;
  }
          ...
          await index2.eachSeries(
            ...
            async (video) => {
              try {
                ...
                results.push({
                  status: 500,
                  message: colors19__default.default.bold.red("ERROR: ") + video.title
                });
              }
            }
          );
...
// scripts/pipes/mix/ListAudioVideoHighest.ts
init_cjs_shims();
...
var program = async () => {
  ...
  switch (command) {
    case "version":
    case "v":
      console.error(colors19__default.default.green("Installed Version: yt-dlx@" + version));
      break;
    case "help":
    case "h":
      scripts_default.info.help().then((data2) => {
        console.log(data2);
        process.exit();
      }).catch((error) => {
        console.error(colors19__default.default.red(error));
        process.exit();
      });
      break;
    case "extract":
    case "e":
      if (!proTube || !proTube.query || proTube.query.length === 0) {
        console.error(colors19__default.default.red("error: no query"));
      } else
    ...
    case "aqc":
      ...
      if (!proTube || !proTube.format || proTube.format.length === 0) {
        console.error(colors19__default.default.red("error: no format"));
      }
