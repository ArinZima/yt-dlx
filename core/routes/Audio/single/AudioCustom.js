...
export default function AudioCustom(_a) {
    return __awaiter(this, arguments, void 0, function* ({ query, output, stream, filter, verbose, onionTor, resolution, }) {
        try {
            ZodSchema.parse({
                query,
                output,
            ...
            let startTime;
            const engineData = yield ytdlx({ query, verbose, onionTor });
