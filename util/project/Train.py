...
class WaterPollutionModel:
    ...
    def tune_model(self, max_trials=100, seed=None, project_name="model/full/core"):
        ...
        self.tuner.search(
            ...
            callbacks=[
                ModelCheckpoint(
                    filepath="model/full/best_model.h5",
                    monitor="val_loss",
                    save_best_only=True,
                ),
                EarlyStopping(monitor="val_loss", patience=10),
                TensorBoard(log_dir="./model/full/logs"),
            ],
        )
    ...
    def train_best_model(self, epochs=100):
        ...
        self.model.load_weights("model/full/best_model.h5")

    # Method to save the model architecture to a JSON file
    def save_model_architecture(self, filename="model/full/architecture.json"):
    ...
    def plot_loss(self):
        ...
        plt.savefig("model/full/loss_plot.png")  # Save plot to file
    ...
    def plot_mae(self):
        ...
        plt.legend()  # Show legend
        plt.savefig("model/full/mae_plot.png")  # Save plot to file
        plt.close()  # Close plot


# Define the path to the data file
data_path = "db/Train.csv"
# Create an instance of the WaterPollutionModel class
water_model = WaterPollutionModel(data_path)
# Load data from the CSV file
water_model.load_data()
# Preprocess the data (encode categorical columns, split into train/test sets)
water_model.preprocess_data()
# Perform hyperparameter tuning to find the best model
water_model.tune_model()
# Train the best model found during tuning
