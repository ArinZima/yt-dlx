...
class WaterPollutionModel:
    ...
    def tune_model(
        self, max_epochs=100, seed=None, project_name="model/hb_guwahti/core"
    ):
        ...
        self.tuner.search(
            ...
            callbacks=[
                ModelCheckpoint(
                    filepath="model/hb_guwahti/best_model.h5",
                    monitor="val_loss",
                    save_best_only=True,
                ),
                EarlyStopping(monitor="val_loss", patience=10),
                TensorBoard(log_dir="./model/hb_guwahti/logs"),
            ],
        )
    ...
    def train_best_model(self, epochs=100):
        ...
        self.model.load_weights("model/hb_guwahti/best_model.h5")

    def save_model_architecture(self, filename="model/hb_guwahti/architecture.json"):
    ...
    def plot_loss(self):
        ...
        plt.legend()
        plt.savefig("model/hb_guwahti/loss_plot.png")
        plt.close()
    ...
    def plot_mae(self):
        ...
        plt.legend()
        plt.savefig("model/hb_guwahti/mae_plot.png")
        plt.close()

    def plot_model_architecture(
        self, filename="model/hb_guwahti/model_architecture.png"
    ):
        plot_model(
