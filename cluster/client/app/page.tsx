...
export default function AwesomePackage() {
  ...
  const { isPending: isNpmPending, data: isNpmVersion } = useQuery({
    queryKey: ["routesData"],
    queryFn: async () => {
      ...
      <main className="overflow-x-hidden max-h-screen scrollbar-thin bg-[#1A1A1C] scrollbar-track-[#1A1A1C] scrollbar-thumb-red-600">
        ...
        <section className="flex flex-col items-center justify-center h-screen">
          <div className="avatar">
            <div className="w-40 mask mask-squircle animate-pulse">
              <img src="/yt-dlx.png" />
            </div>
          </div>
          <div className="flex items-center justify-center gap-2">
            <span className="loading loading-spinner loading-sm text-red-600" />
            <span className="text-red-600 font-black">Loading yt-dlx...</span>
          </div>
        </section>
        ...
        <section className="flex flex-col items-center justify-center">
          <div className="max-w-screen-2xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
              ...
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/Audio/AudioCustom",
                }}
                ...
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      ...
                      covered. Simply provide the available format for the
                      custom resolution, and yt-dlx along with ffmpeg will
                      manage the rest. To identify the available formats,
                      utilize the (list_formats) function.
                    </p>
                  </div>
                </div>
              </Link>
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/Audio/AudioHighest",
                }}
                className="flex items-center hover:animate-pulse cursor-pointer text-red-600 font-extrabold gap-1 mt-2"
              >
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      ...
                      delivery of superior audio resolution and saves the file
                      in the (avi) format.
                    </p>
                  </div>
                </div>
              ...
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/Audio/AudioLowest",
                }}
                className="flex items-center hover:animate-pulse cursor-pointer text-red-600 font-extrabold gap-1 mt-2"
              >
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      This function is automated and employs yt-dlx&apos;s
                      search algorithm to identify the lowest possible audio
                      resolution for a given YouTube video link. Utilizing
                      ffmpeg with the lowest available codecs and bitrate
                      settings, it outputs the minimum audio resolution and
                      saves the file in (avi) format.
                    </p>
                  </div>
                </div>
              </Link>
              ...
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/Video/VideoCustom",
                }}
                className="flex items-center hover:animate-pulse cursor-pointer text-red-600 font-extrabold gap-1 mt-2"
              >
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      This function caters to your specific needs when it comes
                      to downloading a desired video resolution for a given
                      YouTube video link. Simply provide the available format
                      for the custom resolution, and yt-dlx along with ffmpeg
                      will handle the rest. To identify the available formats,
                      use the (list_formats) function.
                    </p>
                  </div>
                </div>
              </Link>
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/Video/VideoHighest",
                }}
                className="flex items-center hover:animate-pulse cursor-pointer text-red-600 font-extrabold gap-1 mt-2"
              >
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      ...
                      best available codecs and bitrate settings, it ensures the
                      delivery of superior video resolution and saves the file
                      in the (mkv) format.
                    </p>
                  </div>
                </div>
              ...
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/Video/VideoLowest",
                }}
                className="flex items-center hover:animate-pulse cursor-pointer text-red-600 font-extrabold gap-1 mt-2"
              >
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      ...
                      resolution for a given YouTube video link. Utilizing
                      ffmpeg with the lowest available codecs and bitrate
                      settings, it produces the video with the least possible
                      resolution and saves the file in the (mkv) format.
                    </p>
                  </div>
                </div>
              </Link>
              ...
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/AudioVideo/AudioVideoCustom",
                }}
                className="flex items-center hover:animate-pulse cursor-pointer text-red-600 font-extrabold gap-1 mt-2"
              >
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
              ...
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/AudioVideo/AudioVideoHighest",
                }}
                className="flex items-center hover:animate-pulse cursor-pointer text-red-600 font-extrabold gap-1 mt-2"
              >
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      This function automatically utilizes yt-dlx&apos;s search
                      algorithm to identify the optimal audio+video resolution
                      for any given YouTube video link. It employs ffmpeg,
                      leveraging the best available codecs and bitrate settings
                      to produce the highest resolution audio+video output,
                      saving the file in (mkv) format.
                    </p>
                  </div>
                </div>
              </Link>
              <Link
                href={{
                  query: { data: isNpmVersion },
                  pathname: "/docs/AudioVideo/AudioVideoLowest",
                }}
                className="flex items-center hover:animate-pulse cursor-pointer text-red-600 font-extrabold gap-1 mt-2"
              >
                <div className="flex items-start gap-1 p-2 rounded-2xl bg-red-950/10 hover:bg-black/80 hover:scale-105 cursor-pointer shadow-2xl shadow-black/60 hover:shadow-red-800/20 duration-300 border border-red-800/20 hover:border-red-800">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      ...
                      resolution for a given YouTube video link. Utilizing
                      ffmpeg with the least resource-intensive codecs and
                      bitrate settings, it outputs the lowest possible
                      audio+video resolution and saves the file in (mkv) format.
                    </p>
                  </div>
                </div>
              </Link>
