const scripts: object[] = [
  {
    ...
    postinstall: `node util/ffmpeg.mjs && node util/engine.mjs && yarn permissions`,
    ...
    clean: {
      main: `yarn clean:base && yarn clean:client && rm -rf util/ffmpeg util/ffmpeg.tar.xz util/engine`,
