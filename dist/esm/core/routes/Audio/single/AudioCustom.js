...
export default function AudioCustom(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var startTime, engineData, title, folder_1, filename_1, ff_1, adata;
        var query = _b.query, resolution = _b.resolution, output = _b.output, stream = _b.stream, verbose = _b.verbose, filter = _b.filter, onionTor = _b.onionTor;
