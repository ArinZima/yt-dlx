...
export default function AudioCustom(input) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, _a, query, resolution, output, stream, verbose, filter, onionTor, engineData, title, folder_1, filename_1, ff_1, adata;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, qconf.parseAsync(input)];
                case 1:
                    _a = _b.sent(), query = _a.query, resolution = _a.resolution, output = _a.output, stream = _a.stream, verbose = _a.verbose, filter = _a.filter, onionTor = _a.onionTor;
                ...
                case 3:
                    ...
                    ff_1 = ffmpeg();
                    adata = engineData.AudioHigh.find(function (i) {
