...
export default function AudioCustom(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var startTime_1, engineData, title, folder_1, filename_1, ff_1, adata, error_1;
        var query = _b.query, output = _b.output, stream = _b.stream, filter = _b.filter, verbose = _b.verbose, onionTor = _b.onionTor, resolution = _b.resolution;
