...
export default function ListAudioCustom(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        var query = _b.query, output = _b.output, filter = _b.filter, verbose = _b.verbose, onionTor = _b.onionTor, resolution = _b.resolution;
            ...
            switch (_h.label) {
                ...
                case 13:
                    ...
                    _loop_1 = function (video) {
                        var engineData, title, folder_1, filename_1, ff_1, adata, error_3;
