...
export default function ListAudioVideoCustom(input) {
    return __awaiter(this, void 0, void 0, function () {
        var startTime, _a, query, resolution, verbose, output, filter, onionTor, vDATA, query_1, query_1_1, pURL, pDATA, _b, _c, _d, _e, video, error_1, e_1_1, _loop_1, vDATA_1, vDATA_1_1, video, e_2_1;
        var e_1, _f, _g, e_3, _h, e_2, _j;
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0: return [4 /*yield*/, qconf.parseAsync(input)];
                case 1:
                    _a = _k.sent(), query = _a.query, resolution = _a.resolution, verbose = _a.verbose, output = _a.output, filter = _a.filter, onionTor = _a.onionTor;
                    vDATA = new Set();
                    _k.label = 2;
                case 2:
