...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var resolutions, resolutions_1, resolutions_1_1, resolution, error_1, e_1_1, error_2;
    var e_1, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 11, , 12]);
                resolutions = ["high", "medium", "low", "ultralow"];
                _b.label = 1;
            case 1:
                ...
                _b.label = 2;
            case 2:
                if (!!resolutions_1_1.done) return [3 /*break*/, 7];
                resolution = resolutions_1_1.value;
                _b.label = 3;
            case 3:
                _b.trys.push([3, 5, , 6]);
                return [4 /*yield*/, AudioCustom({
