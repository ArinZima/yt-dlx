...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        Tube = yield web_1.default.browserLess.searchVideos({ query: "weeknd" });
        console.log(colors_1.default.green("searchVideos"), Tube[0]);
        Tube = yield web_1.default.browserLess.searchPlaylists({ query: Tube[0].title });
        console.log(colors_1.default.green("searchPlaylists"), Tube[0]);
        Tube = yield web_1.default.browserLess.playlistVideos({ playlistId: Tube[0].id });
        console.log(colors_1.default.green("playlistVideos"), Tube[0]);
        Tube = yield web_1.default.browserLess.relatedVideos({ videoId: Tube[0].id });
        console.log(colors_1.default.green("relatedVideos"), Tube[0]);
        Tube = yield web_1.default.browserLess.singleVideo({ videoId: Tube[0].id });
